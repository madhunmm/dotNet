Public Class SpeechGrammar
    ...
    Public Sub AddRule(ByVal ruleName As String)
        ...
        If (Not bExists) Then
            ...
            While (fileReader.EndOfStream = False)
                ...
                Else
                    ...
                    fileWriter.WriteLine(vbTab + vbTab + phraseStartTag + ruleName + phraseEndTag)
    ...
    Public Function GetRulesList() As String()
        ...
        While (fileReader.EndOfStream = False)
            Dim line As String
            line = fileReader.ReadLine()
            If (line.Contains(phraseStartTag)) Then
                line = line.Replace(phraseStartTag, "")
                line = line.Replace(phraseEndTag, "")
                list.Add(line.Trim())
            End If
        End While
        fileReader.Close()
