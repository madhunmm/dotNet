Module Keyboard
    ...
    Public Sub PressKey(ByVal sKey As String, Optional ByVal bHold As Boolean = False, Optional ByVal _
       bRelease As Boolean = False)
    ...
    Public Sub PressString(ByVal sString As String, Optional ByVal bDoEvents As Boolean = True)
    ...
    ' ascii equilivant)
    Public Sub PressKeyVK(ByVal keyPress As enumKeys, Optional ByVal bHold As Boolean = False, _
       Optional ByVal bRelease As Boolean = False, Optional ByVal bCompatible As Boolean = False)
    ...
    Public Sub GetLockStatus(ByVal bCapsLock As Boolean, ByVal bNumLock As Boolean, _
       ByVal bScrollLock As Boolean)
